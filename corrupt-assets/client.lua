...
-- DisableInteriorProp(int_plan1, "set_plan_wall") --stone wall
...
--		RequestIpl("ex_dt1_11_office_03c")
	...
	--end
Citizen.CreateThread(function()
	local xyz = GetInteriorAtCoords(1113.974, -1806.528, 20.0346)
	ActivateInteriorEntitySet(xyz, "car_meet_set_01")
	ActivateInteriorEntitySet(xyz, "car_meet_set_05")
	ActivateInteriorEntitySet(xyz, "car_meet_set_06")
	ActivateInteriorEntitySet(xyz, "car_meet_set_07")
	ActivateInteriorEntitySet(xyz, "car_meet_set_08")
	RefreshInterior(xyz)
end)
